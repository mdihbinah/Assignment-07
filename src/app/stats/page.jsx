...
const Stats = () => {
    ...
    return (
        <div className='w-[90%] my-5 mx-auto'>
            ...
            <div className={`bg-gray-700 flex flex-col justify-center items-center gap-3 p-10 my-5 rounded-md md:rounded-xl text-xl text-center md:text-4xl ${user.length == 0? '': 'hidden'}`}>
            <BiFileBlank className="lg:text-8xl" />
                There are no information.
            </div>
            <div className={`p-10 mt-5 rounded-2xl bg-gray-700 ${user.length == 0? 'hidden': ''}`}>
